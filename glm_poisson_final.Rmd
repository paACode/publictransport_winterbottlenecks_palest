...
The model provides the following results:
 ...
 - Changing the event to "Meiringen Reopened" (while keeping all other factors constant) results in an average of 28 * 0.45 = 14 delayed observations per hour.


## Conclusion

The model allows for predicting the expected number of delayed trains per hour across different event and operational categories.
