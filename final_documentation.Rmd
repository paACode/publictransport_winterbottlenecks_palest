...
| `w_precip_mm_Engelberg`   | Continuous    |
| `w_precip_mm_Luzern`      | Continuous    |
| `w_precip_mm_Meiringen`   | Continuous    |
| `w_temp_min_c_Engelberg`  | Continuous    |
| `w_temp_min_c_Luzern`     | Continuous    |
| `w_temp_min_c_Meiringen`  | Continuous    |
| `w_temp_avg_c_Engelberg`  | Continuous    |
| `w_temp_avg_c_Luzern`     | Continuous    |
| `w_temp_avg_c_Meiringen`  | Continuous    |
...
All public transport data used in this project was obtained from OpenTransportData, which provides official, high-resolution datasets on public transportation in Switzerland. Weather-related data was sourced from XXX, offering location-specific historical weather records relevant to the operational context.
