...
While the table summarizes the original data types, some variables are adapted for specific models. `ANKUNFTDELAY_sec` and `ABFAHRTDELAY_sec`, though continuous, are treated as count data in the corresponding chapter where the model requires it. Similarly, `DELAY_Category` is transformed into a binomial variable for binary classification tasks.
