...
- Also all derived columns like ABFAHRTDELAY_sec", "ABFAHRTDELAY_min","ANKUNFTDELAY_sec", "ANKUNFTDELAY_min", "RUSH_HOUR", "TAGESZEIT", "DELAY_CATEGORY", "ZIEL", "START" are dropped
- "FAHRT_BEZEICHNER" we also drop because it has to many levels 384 --> takes to long
